  ...
  return (
    <div className="card w-full max-w-4xl">
      ...
      <div className="text-center mb-10">
        ...
        <div className={`text-7xl md:text-8xl font-black mb-4 ${getTierColor(totalScore)}`}>
          {totalScore}
        </div>
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        ...
        <div className="glass-strong rounded-xl p-6 hover:scale-105 transition-transform duration-300">
          <h3 className="text-2xl font-bold mb-6 flex items-center gap-3">
            ...
            <span className="ml-auto text-blue-300 font-bold">{cameraScore} pts</span>
          </h3>
        ...
        <div className="glass-strong rounded-xl p-6 hover:scale-105 transition-transform duration-300">
          <h3 className="text-2xl font-bold mb-6 flex items-center gap-3">
            ...
            <span className="ml-auto text-purple-300 font-bold">{voiceScore} pts</span>
          </h3>
          {buzzwords.length > 0 ? (
            <ul className="space-y-3">
